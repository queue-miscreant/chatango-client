...
# Current Maintainers Of The Main Library: Nullspeaker
# Branch Owner: ASL97 <asl97@outlook.com>
# Current Maintainers Of The Branch Library: ASL97
# Version: 1.00
# Description:
...
class PM:
  ...
  def rcmd_msg(self, args):
    ...
    raw = ":".join(args)
    self._callEvent("onPMMessage", user, body, raw)
