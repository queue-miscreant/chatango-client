 ...
 * Richard Wong - 2012-04-27 Python version bug fixes
 *
...
if __name__ == '__main__':
    import unicodedata
    test_strings = [
        u'Pál Erdős', u'Kurt Gödel', u'Évariste Galois',
        u"Guillaume de l'Hôpital",
    ...
    for s in test_strings:
        ...
        d = unicodedata.normalize(u'NFD', s)
